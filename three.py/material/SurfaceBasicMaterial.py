...
class SurfaceBasicMaterial(Material):
	def __init__(self, color=[1,1,1], alpha=1, texture=None, isSpecular=0, useFog=0, fogStartDistance=5, fogEndDistance=15, fogColor=[1,1,1],useLight=0, wireframe = False, lineWidth=1):
