...
class QuadGridGeometry(Geometry):
    ...
    def __init__(self, groups, xRes=1, yRes=1, xSize=1, ySize=1):
        super().__init__()
        self.groups = groups
        ...
        ## points is a list of GridGroups from the helper class, which contain a dict labeled (x,y): 1,2,3,4
        ## which are points on a quad, specified by x and y. Based on the points given, different triangles can be formed.
